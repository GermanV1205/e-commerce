...
/src
├── /auth
│   └── Lógica de JWT, Guards, Strategies de login
│
├── /users
│   └── Gestión de perfiles, roles y direcciones
│
├── /catalog
│   └── Productos, Categorías y Variantes (Tallas/Colores)
│
├── /orders
│   └── Carrito, Checkout, Pedidos e Historial
│
├── /inventory
│   └── Movimientos de stock (Kardex)
│
└── /common
    └── Excepciones globales, decoradores personalizados e interceptores